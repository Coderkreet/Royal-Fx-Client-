...
const Sidebar = ({ isExpanded, setIsExpanded }) => {
  ...
  const menuItems = [
    ...
    { icon: <PiHandCoinsFill size={20} />, text: "Royal-Fx", path: AuthenticatedRoutes.NEBULUX_COIN },
    ...
    { icon: <Calendar size={20} />, text: "Profit History", path: AuthenticatedRoutes.ROI_HISTORY },
